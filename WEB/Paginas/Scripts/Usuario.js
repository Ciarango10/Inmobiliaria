...
function LlenarComboPerfiles() {
    LlenarComboXServicios("https://localhost:44340/api/Perfiles/ListarPerfiles", "#cboPerfil")
}

function LlenarTablaPerfilesEmpleados() {
    LlenarTablaXServicios("https://localhost:44340/api/Usuarios/ListarUsuariosEmpleados", "#tblUsuarios");
}
...
async function Buscar() {
    try {
        ...
        //Invoca el fetch
        const Respuesta = await fetch("https://localhost:44340/api/Empleados/ConsultarConCargo?Documento=" + Documento,
            {
                method: "GET",
                mode: "cors",
...
async function EjecutarComando(Comando, Metodo) {
    ...
    let Extension = "";
    let sURLBase = "https://localhost:44340/api/Usuarios/";
